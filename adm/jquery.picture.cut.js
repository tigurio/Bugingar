...
$(function() {
    ...
    PcLoading = {
        show: function(c, a) {
            ...
            a = "undefined" == typeof a ? "Carregando Imagem" : a;
            var d = $("<div></div>").css("text-align", "center"),
                f = $("<img alt='carregando' src='"+ __IMAGE_LOADING +"'  />").css({
                    //"float": "left",
                    //"margin-right": "20px",
                    //"margin-top": "-5px"
                    "margin-bottom": "5px"
    ...
    a.fn.uploadAjax = function(g) {
        ...
        return this.each(function() {
            ...
            h.css({
                ...
                "z-index": 10,
                overflow: "hidden"
            }).attr("title", "Selecione uma imagem");
...
(function($) {
    var methods = {
        ...
        init: function(Options) {
            var OptionsIfEmpty = {
                ActionToSubmitUpload: "php/upload.php",
                ActionToSubmitCrop: "php/crop.php",
                DefaultImageButton: "img/icon_add_image2.png"
            };
            var defaults = {
            ...
            //__IMAGE_LOADING = Options.PluginFolderOnServer + "img/ajaxloader.gif";
            __IMAGE_LOADING =  "uploadImage/src/img/ajaxloader.gif";
            ...
            if (Options.CropWindowStyle.toLowerCase() == "bootstrap") {
                ...
                if ($("#" + id).size() == 0) {
                    $('<link/>', {
                        ...
                        rel: 'stylesheet',
                        type: 'text/css',
                        href: Options.PluginFolderOnServer + 'windows/JanelaBootstrap/jquery-ui-1.10.0.custom.css'
                    }).appendTo('head')
                }
            };
            ...
            return this.each(function() {
                var Elemento;
                var CropWindowStyle = {
                    "jqueryui": "windows/window.jqueryui.php",
                    "popstyle": "windows/window.popstyle.php",
                    "bootstrap": "windows/window.bootstrap.php"
                };
                var $EnableButton;
                JpaneDialogCrop = function(action, titulo, w, h, wmodal, drag, resize, post, Call) {
                    ...
                    var $modal = $("<div id='JtuyoshiCrop_model' />").css({
                        ...
                        "border": "1px #CCC solid",
                        "background-image": "url(" + __IMAGE_LOADING + ")",
                        "background-image": "url(" + Options.PluginFolderOnServer + "img/fundo_crop.png)",
                        "z-index": 598
                    });
                ...
                var TuyoshiCrop = function(element, response) {
                    ...
                    var JpaneDialogCallBack = function() {
                        $.getScript(Options.PluginFolderOnServer + "windows/core/window.pc.js");
